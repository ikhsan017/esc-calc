...
<div class="col-lg-10 mx-auto esc-page esc-page-infield-erosion-control"
    ...
    <div class="page-buttons">
        <a class="btn btn-light btn-xl btn-page" href="#esc_page_land_location">Previous</a>
        <a class="btn btn-primary btn-xl btn-page" href="#esc_page_sediment_control_measure">Continue</a>
    </div>
</div>